...
function StoryGame({story, onNewStory}) {
    console.log("debug message StoryGame.jsx story-------------------: ",story)
    ...
    const chooseOption = (optionId) => {
        ...
        console.log("chooseOption called with:", optionId) 

    }

    const restartStory = () => {
        console.log("restartStory called") 
        if (story && story.root_node) {
            console.log("restartStory called with root_node.idid:", story.root_node.id)
